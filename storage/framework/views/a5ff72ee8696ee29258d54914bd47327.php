    ...
    <div class="container mx-auto p-6">
        <div class="bg-white p-8 rounded-lg shadow-md max-w-lg mx-auto text-center">
            ...
            <div class="bg-gray-100 p-4 rounded-lg shadow-inner mb-6">
                ...
                <!-- Customer Name -->
                <p class="text-lg font-medium mb-2">👤 Name: <span class="font-semibold"><?php echo e($name); ?></span></p>

                <!-- Customer Address -->
                <p class="text-lg font-medium mb-2">🏠 Address: <span class="font-semibold"><?php echo e($address); ?></span></p>

                <!-- Total Items -->
                <p class="text-lg font-medium mb-2">🛒 Total Items: <span class="font-semibold"><?php echo e($total_items); ?></span></p>

                <!-- Total Price -->
                <p class="text-lg font-medium mb-2">💵 Total Price: <span class="font-semibold"><?php echo e($total_price); ?></span></p>

                <!-- Customer Contact Number -->
                <p class="text-lg font-medium">📞 Contact Number: <span class="font-semibold"><?php echo e($phone); ?></span></p>
            </div>
...
<?php /**PATH D:\College\Semester 7th\Laravel\new_ca\resources\views/Checkout.blade.php ENDPATH**/ ?>